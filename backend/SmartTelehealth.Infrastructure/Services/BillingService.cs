...
public class BillingService : IBillingService
{
    ...
    public async Task<JsonModel> CreateBillingRecordAsync(CreateBillingRecordDto createDto)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "An error occurred while creating the billing record", StatusCode = 500 };
        }
    }
    ...
    private async Task<JsonModel> ProcessPaymentWithRetryAsync(Guid billingRecordId, int attempt)
    {
        try
        {
            ...
            if (billingRecord.Status == BillingRecord.BillingStatus.Paid)
                return new JsonModel { data = new object(), Message = "Payment has already been processed", StatusCode = 400 };
            ...
            if (defaultPaymentMethod == null)
            {
                ...
                return new JsonModel { data = new object(), Message = "No default payment method found", StatusCode = 400 };
            }
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "An error occurred while processing payment", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> RetryPaymentAsync(Guid billingRecordId)
    {
        try
        {
            ...
            if (result.Success)
            {
                return JsonModel.SuccessResponse(new PaymentResultDto
                {
            ...
            return new JsonModel { data = new object(), Message = "Payment retry failed", StatusCode = 400 };
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error retrying payment for billing record {BillingRecordId}", billingRecordId);
            return new JsonModel { data = new object(), Message = "Failed to retry payment", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> ProcessRefundAsync(Guid billingRecordId, decimal amount, string reason)
    {
        try
        {
            ...
            if (billingRecord.Status != BillingRecord.BillingStatus.Paid)
                return new JsonModel { data = new object(), Message = "Only paid billing records can be refunded", StatusCode = 400 };

            if (string.IsNullOrEmpty(billingRecord.PaymentIntentId))
                return new JsonModel { data = new object(), Message = "No payment intent found for refund", StatusCode = 400 };
            ...
            if (refundResult)
            {
                ...
                return JsonModel.SuccessResponse(new RefundResultDto
                {
            ...
            return new JsonModel { data = new object(), Message = "Failed to process refund", StatusCode = 400 };
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error processing refund for billing record {BillingRecordId}", billingRecordId);
            return new JsonModel { data = new object(), Message = "Failed to process refund", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> GetBillingRecordAsync(Guid billingRecordId)
    {
        try
        {
            ...
            return JsonModel.SuccessResponse(MapToDto(billingRecord));
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error getting billing record {BillingRecordId}", billingRecordId);
            return new JsonModel { data = new object(), Message = "Failed to retrieve billing record", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> GetRevenueSummaryAsync(DateTime? from = null, DateTime? to = null, string? planId = null)
    {
        ...
        return new JsonModel { data = summary, Message = "Success", StatusCode = 200 };
    }
    ...
    public async Task<JsonModel> CreateRecurringBillingAsync(CreateRecurringBillingDto createDto)
    {
        ...
        return new JsonModel { data = billingRecordDto, Message = "Recurring billing record created successfully", StatusCode = 200 };
    }
    public async Task<JsonModel> ProcessRecurringPaymentAsync(Guid subscriptionId)
    {
        ...
        if (nextDue == null)
            return new JsonModel { data = new object(), Message = "No pending recurring payment found", StatusCode = 404 };
    ...
    public async Task<JsonModel> CancelRecurringBillingAsync(Guid subscriptionId)
    {
        ...
        return new JsonModel { data = true, Message = "Recurring billing cancelled", StatusCode = 200 };
    }
    public async Task<JsonModel> CreateUpfrontPaymentAsync(CreateUpfrontPaymentDto createDto)
    {
        ...
        return new JsonModel { data = billingRecordDto, Message = "Upfront payment processed successfully", StatusCode = 200 };
    }
    public async Task<JsonModel> ProcessBundlePaymentAsync(CreateBundlePaymentDto createDto)
    {
        ...
        return new JsonModel { data = billingRecordDto, Message = "Bundle payment processed successfully", StatusCode = 200 };
    }
    ...
    public async Task<JsonModel> GetBillingAdjustmentsAsync(Guid billingRecordId)
    {
        ...
        return new JsonModel { data = dtos, Message = "Billing adjustments retrieved successfully", StatusCode = 200 };
    }
    public async Task<JsonModel> RetryFailedPaymentAsync(Guid billingRecordId)
    {
        ...
        if (billingRecord.Status != BillingRecord.BillingStatus.Failed)
            return new JsonModel { data = new object(), Message = "Billing record is not in failed status", StatusCode = 400 };
    ...
    public async Task<JsonModel> ProcessPartialPaymentAsync(Guid billingRecordId, decimal amount)
    {
        ...
        if (amount <= 0 || amount > billingRecord.Amount)
            return new JsonModel { data = new object(), Message = "Invalid partial payment amount", StatusCode = 400 };
    ...
    public async Task<JsonModel> CreateInvoiceAsync(CreateInvoiceDto createDto)
    {
        ...
        return new JsonModel { data = billingRecordDto, Message = "Invoice created successfully", StatusCode = 200 };
    }
    public async Task<JsonModel> GenerateInvoicePdfAsync(Guid billingRecordId)
    {
        ...
        return new JsonModel { data = pdfBytes, Message = "Invoice PDF generated", StatusCode = 200 };
    }
    public async Task<JsonModel> GenerateBillingReportAsync(DateTime startDate, DateTime endDate, string format = "pdf")
    {
        ...
        return new JsonModel { data = reportBytes, Message = "Billing report generated", StatusCode = 200 };
    }
    public async Task<JsonModel> GetBillingSummaryAsync(int userId, DateTime? startDate = null, DateTime? endDate = null)
    {
        ...
        return new JsonModel { data = summary, Message = "Billing summary generated", StatusCode = 200 };
    }
    public async Task<JsonModel> GetPaymentScheduleAsync(Guid subscriptionId)
    {
        ...
        return new JsonModel { data = schedule, Message = "Payment schedule generated", StatusCode = 200 };
    }
    public async Task<JsonModel> UpdatePaymentMethodAsync(Guid billingRecordId, string paymentMethodId)
    {
        ...
        return await Task.FromResult(JsonModel.ErrorResponse("Not implemented in infrastructure layer", 501));
    }
    /// <summary>
    ...
    public async Task<JsonModel> CreateBillingCycleAsync(CreateBillingCycleDto createDto)
    {
        ...
        return new JsonModel { data = billingRecordDto, Message = "Billing cycle created successfully", StatusCode = 200 };
    }
    public async Task<JsonModel> GetBillingCycleRecordsAsync(Guid billingCycleId)
    {
        ...
        return new JsonModel { data = dtos, Message = "Billing cycle records retrieved successfully", StatusCode = 200 };
    }
    public async Task<JsonModel> ProcessBillingCycleAsync(Guid billingCycleId)
    {
        ...
        var dtos = records.Select(MapToDto);
        return new JsonModel { data = dtos.FirstOrDefault(), Message = "Billing cycle processed", StatusCode = 200 };
    }
    ...
    public async Task<JsonModel> ExportRevenueAsync(DateTime? from = null, DateTime? to = null, string? planId = null, string format = "csv")
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to export revenue data", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> GetUserBillingHistoryAsync(int userId)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to get billing history", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> GetAllBillingRecordsAsync()
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to get billing records", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> GetSubscriptionBillingHistoryAsync(Guid subscriptionId)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to get subscription billing history", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> ProcessRefundAsync(Guid billingRecordId, decimal amount)
    {
        try
        {
            var billingRecord = await _billingRepository.GetByIdAsync(billingRecordId);
            if (billingRecord == null)
                return new JsonModel { data = new object(), Message = "Billing record not found", StatusCode = 500 };

            if (string.IsNullOrEmpty(billingRecord.StripePaymentIntentId))
                return new JsonModel { data = new object(), Message = "No payment intent found for refund", StatusCode = 500 };
            ...
            if (refundResult)
            {
                ...
                return JsonModel.SuccessResponse(MapToDto(updatedRecord));
            }
    ...
    public async Task<JsonModel> GetOverdueBillingRecordsAsync()
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to get overdue billing records", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> GetPendingPaymentsAsync()
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to get pending payments", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> CalculateTotalAmountAsync(decimal subtotal, decimal tax, decimal shipping)
    {
        try
        {
            ...
            return new JsonModel { data = total, Message = "Success", StatusCode = 200 };
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error calculating total amount");
            return new JsonModel { data = new object(), Message = "Failed to calculate total amount", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> CalculateTaxAmountAsync(decimal amount, string taxRate)
    {
        try
        {
            if (decimal.TryParse(taxRate, out var rate))
            {
                ...
                return new JsonModel { data = tax, Message = "Success", StatusCode = 200 };
            }
            return new JsonModel { data = new object(), Message = "Invalid tax rate", StatusCode = 500 };
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error calculating tax amount");
            return new JsonModel { data = new object(), Message = "Failed to calculate tax amount", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> CalculateShippingAmountAsync(string shippingMethod, bool isExpress)
    {
        try
        {
            ...
            return new JsonModel { data = totalShipping, Message = "Success", StatusCode = 200 };
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error calculating shipping amount");
            return new JsonModel { data = new object(), Message = "Failed to calculate shipping amount", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> IsPaymentOverdueAsync(Guid billingRecordId)
    {
        try
        {
            ...
            return new JsonModel { data = isOverdue, Message = "Success", StatusCode = 200 };
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error checking if payment is overdue for billing record {BillingRecordId}", billingRecordId);
            return new JsonModel { data = new object(), Message = "Failed to check payment overdue status", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> CalculateDueDateAsync(DateTime startDate, int daysToAdd)
    {
        try
        {
            ...
            return new JsonModel { data = dueDate, Message = "Success", StatusCode = 200 };
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error calculating due date");
            return new JsonModel { data = new object(), Message = "Failed to calculate due date", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> GetBillingAnalyticsAsync()
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to get billing analytics", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> GetPaymentHistoryAsync(int userId, DateTime? startDate = null, DateTime? endDate = null)
    {
        try
        {
            ...
            return new JsonModel { data = .SuccessResponse(paymentHistory);
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error getting payment history for user {UserId}", userId);
            return new JsonModel { data = new object(), Message = "Failed to get payment history", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> GetPaymentAnalyticsAsync(DateTime? startDate = null, DateTime? endDate = null)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to get payment analytics", StatusCode = 500 };
        }
    }
