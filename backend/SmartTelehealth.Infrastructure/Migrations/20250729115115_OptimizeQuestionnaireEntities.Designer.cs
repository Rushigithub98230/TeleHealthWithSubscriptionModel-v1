...
namespace SmartTelehealth.Infrastructure.Migrations
{
    ...
    [Migration("20250729115115_OptimizeQuestionnaireEntities")]
    partial class OptimizeQuestionnaireEntities
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Questions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Questions_Range_Values", "([Type] != 'range') OR ([MinValue] IS NULL AND [MaxValue] IS NULL) OR ([MinValue] IS NOT NULL AND [MaxValue] IS NOT NULL AND [MinValue] < [MaxValue])");
                        });
                });
            ...
            modelBuilder.Entity("SmartTelehealth.Core.Entities.UserResponse", b =>
                {
                    ...
                    b.ToTable("UserResponses", null, t =>
                        {
                            t.HasCheckConstraint("CK_UserResponses_Status_Valid", "[Status] IN ('draft', 'completed', 'submitted', 'in_progress', 'reviewed', 'approved', 'rejected')");
                        });
                });
