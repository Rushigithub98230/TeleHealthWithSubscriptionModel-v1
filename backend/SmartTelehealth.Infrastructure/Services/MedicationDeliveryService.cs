...
public class MedicationDeliveryService : IMedicationDeliveryService
{
    ...
    public async Task<JsonModel> GetByIdAsync(Guid id)
    {
        try
        {
            ...
            if (delivery == null)
                return new JsonModel { data = new object(), Message = "Medication delivery not found", StatusCode = 500 };
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to get medication delivery", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> GetByUserIdAsync(int userId)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to get medication deliveries", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> CreateAsync(CreateMedicationDeliveryDto createDto)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to create medication delivery", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> UpdateAsync(Guid id, UpdateMedicationDeliveryDto updateDto)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to update medication delivery", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> DeleteAsync(Guid id)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Failed to delete medication delivery", StatusCode = 500 };
        }
    }
