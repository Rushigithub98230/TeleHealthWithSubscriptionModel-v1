...
namespace SmartTelehealth.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentTypes_Users_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DocumentTypes_Users_UpdatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentReferences_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentReferences_CreatedAt",
                table: "DocumentReferences",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentReferences_CreatedById",
                table: "DocumentReferences",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_CreatedById_IsDeleted",
                table: "Documents",
                columns: new[] { "CreatedById", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentTypes_DeletedById",
                table: "DocumentTypes",
                column: "DeletedById");
