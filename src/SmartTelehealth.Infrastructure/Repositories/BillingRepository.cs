...
namespace SmartTelehealth.Infrastructure.Repositories
{
    public class BillingRepository : IBillingRepository
    {
        ...
        public Task<IEnumerable<BillingAdjustment>> GetAdjustmentsByBillingIdAsync(Guid billingId) => Task.FromResult<IEnumerable<BillingAdjustment>>(new List<BillingAdjustment>());
