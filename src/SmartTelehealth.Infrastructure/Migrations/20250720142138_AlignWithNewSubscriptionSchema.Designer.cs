...
namespace SmartTelehealth.Infrastructure.Migrations
{
    ...
    [Migration("20250720142138_AlignWithNewSubscriptionSchema")]
    partial class AlignWithNewSubscriptionSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartTelehealth.Core.Entities.AppointmentInvitation", b =>
                {
                    ...
                    b.Property<Guid?>("InvitationStatusId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("InvitationStatusId1");
            ...
            modelBuilder.Entity("SmartTelehealth.Core.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("SmartTelehealth.Core.Entities.PaymentStatus", null)
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("SmartTelehealth.Core.Entities.AppointmentInvitation", b =>
                {
                    ...
                    b.HasOne("SmartTelehealth.Core.Entities.InvitationStatus", null)
                        .WithMany("Invitations")
                        .HasForeignKey("InvitationStatusId1");
