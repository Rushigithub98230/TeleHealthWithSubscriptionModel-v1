...
public class VideoCallService : IVideoCallService
{
    ...
    public async Task<JsonModel> GetByIdAsync(Guid id)
    {
        try
        {
            ...
            if (videoCall == null)
            {
                return new JsonModel { data = new object(), Message = "Video call not found", StatusCode = 404 };
            }

            var videoCallDto = MapToDto(videoCall);
            return new JsonModel { data = videoCallDto, Message = "Success", StatusCode = 200 };
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error getting video call with ID {VideoCallId}", id);
            return new JsonModel { data = new object(), Message = "Error retrieving video call", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> GetByUserIdAsync(int userId)
    {
        try
        {
            ...
            return new JsonModel { data = .SuccessResponse(videoCallDtos);
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error getting video calls for user {UserId}", userId);
            return new JsonModel { data = new object(), Message = "Error retrieving video calls", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> CreateAsync(CreateVideoCallDto createDto)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error creating video call", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> UpdateAsync(Guid id, UpdateVideoCallDto updateDto)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error updating video call", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> DeleteAsync(Guid id)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error deleting video call", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> InitiateVideoCallAsync(CreateVideoCallDto createDto)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error initiating video call", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> JoinVideoCallAsync(Guid callId, int userId)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error joining video call", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> LeaveVideoCallAsync(Guid callId, int userId)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error leaving video call", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> EndVideoCallAsync(Guid callId, string? reason = null)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error ending video call", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> RejectVideoCallAsync(Guid callId, string reason)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error rejecting video call", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> ToggleVideoAsync(Guid callId, bool enabled)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error toggling video", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> ToggleAudioAsync(Guid callId, bool enabled)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error toggling audio", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> StartScreenSharingAsync(Guid callId)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error starting screen sharing", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> StopScreenSharingAsync(Guid callId)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error stopping screen sharing", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> UpdateCallQualityAsync(Guid callId, int audioQuality, int videoQuality, int networkQuality)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error updating call quality", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> GetVideoCallParticipantsAsync(Guid callId)
    {
        try
        {
            ...
            return new JsonModel { data = .SuccessResponse(participants);
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error getting participants for call {CallId}", callId);
            return new JsonModel { data = new object(), Message = "Error getting participants", StatusCode = 500 };
        }
    }
    ...
    public async Task<JsonModel> LogVideoCallEventAsync(Guid callId, LogVideoCallEventDto eventDto)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new JsonModel { data = new object(), Message = "Error logging video call event", StatusCode = 500 };
        }
    }
